...
Options[RiemannTensor]=Join[Options[ShiftIndices],{"ActWithNested"->Identity}];
Options[RicciTensor]=Options[RiemannTensor];
Options[RicciScalar]=Options[RiemannTensor];
Options[EinsteinTensor]=Options[RiemannTensor];
Options[WeylTensor]=Options[RiemannTensor];
Options[CottonTensor]=Options[RiemannTensor];
Options[FieldStrengthTensor]=Options[RiemannTensor];
Options[MaxwellStressEnergyTensor]=Options[RiemannTensor];
Options[KretschmannScalar]=Options[RiemannTensor];
Options[BianchiIdentities]=Options[RiemannTensor];

DocumentationBuilder`OptionDescriptions["RiemannTensor"] = Join[DocumentationBuilder`OptionDescriptions["ShiftIndices"],
...
DocumentationBuilder`OptionDescriptions["RicciTensor"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
DocumentationBuilder`OptionDescriptions["RicciScalar"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
DocumentationBuilder`OptionDescriptions["EinsteinTensor"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
DocumentationBuilder`OptionDescriptions["WeylTensor"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
DocumentationBuilder`OptionDescriptions["CottonTensor"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
DocumentationBuilder`OptionDescriptions["FieldStrengthTensor"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
DocumentationBuilder`OptionDescriptions["MaxwellStressEnergyTensor"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
DocumentationBuilder`OptionDescriptions["KretschmannScalar"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
DocumentationBuilder`OptionDescriptions["BianchiIdentities"] = DocumentationBuilder`OptionDescriptions["RiemannTensor"];
...
Module[{n,xx,vals,name,simpFn,simpFnNest,chr,posInds,
	...
	ToTensor[{name,"R"},gT,vals,{-a,-b,-c,-d}]			
]
...
Module[{rie,name,i,j,k,simpFnNest,simpFn,tests},
	...
	If[RawTensorValues[name,{"Down","Down"}]===Undefined,
		ContractIndices[rie[k,-i,-k,-j],{name,"R"},"ActWith"->simpFn],
		
		ToTensor[{name,"R"},g,RawTensorValues[name,{"Down","Down"}],{-i,-j}]
	]		
]
...
Module[{ric,i,simpFnNest,simpFn,tests},
	...
	ContractIndices[ShiftIndices[ric,{-i,i},"ActWith"->simpFnNest],"ActWith"->simpFn]		
...
Module[{ricT,ricS,name,i,j,simpFnNest,simpFn,tests},
	...
	If[RawTensorValues[name,{"Down","Down"}]===Undefined,
		...
		ToTensor[{name,"G"},g,RawTensorValues[name,{"Down","Down"}],{-i,-j}]
	]		
]
...
Module[{rie,ricT,ricS,dim,i,k,l,m,name,simpFnNest,simpFn,tests},
	...
	If[RawTensorValues[name,{"Down","Down","Down","Down"}]===Undefined,
		...
		ToTensor[{name,"C"},g,RawTensorValues[name,{"Down","Down","Down","Down"}],{-i,-k,-l,-m}]
	]
]
...
Module[{ricT,ricS,dim,i,j,k,name,simpFnNest,simpFn,tests},
	...
	If[RawTensorValues[name,{"Down","Down","Down"}]===Undefined,
		...
		ToTensor[{name,"C"},g,RawTensorValues[name,{"Down","Down","Down"}],{-i,-j,-k}]
	]
]
...
Module[{g,name,i,j,simpFnNest,simpFn,tests},
	...
	If[RawTensorValues[name,{"Down","Down"}]===Undefined,
		...
		ToTensor[{name,"F"},g,RawTensorValues[name,{"Down","Down"}],{-i,-j}]
	]
];
...
Module[{g,name,i,k,l,m,simpFnNest,simpFn,tests},
	...
	If[RawTensorValues[name,{"Up","Up"}]===Undefined,
		...
		ToTensor[{name,"T"},g,RawTensorValues[name,{"Up","Up"}],{i,k}]
	]
];
...
Module[{rie,i,j,k,l,simpFnNest,simpFn,tests},
	...
	MergeTensors[ShiftIndices[rie,{i,j,k,l},"ActWith"->simpFnNest]ShiftIndices[rie,{-i,-j,-k,-l},"ActWith"->simpFnNest],"ActWith"->simpFn,"ActWithNested"->simpFnNest]		
]


def@
BianchiIdentities[t_Tensor?MetricQ,contractions_Integer,opts:OptionsPattern[]]:=
...
reDef@
BianchiIdentities[t_Tensor?MetricQ,opts:OptionsPattern[]]:=BianchiIdentities[t,0,opts]
